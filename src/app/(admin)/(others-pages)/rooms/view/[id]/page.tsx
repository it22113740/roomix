...
export default function RoomViewPage() {
  ...
  if (!room) {
    return (
      <div>
        <PageBreadcrumb pageTitle="Room Details" />
        <ComponentCard title="Room Not Found">
          <div className="text-center py-12">
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              Room not found.
            </p>
            <Link href="/rooms">
              <Button startIcon={<ChevronLeftIcon />}>Back to Rooms</Button>
            </Link>
          </div>
        </ComponentCard>
      </div>
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle={`Room ${room.roomNumber} - Details`} />
      ...
      <ComponentCard title={`Room ${room.roomNumber} - Details`}>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                {room.images.map((imageUrl, index) => (
                  <div
                    key={index}
                    className="relative overflow-hidden rounded-lg border border-gray-200 dark:border-gray-800 aspect-video bg-gray-100 dark:bg-gray-800"
                  >
                    <Image
                      src={imageUrl}
